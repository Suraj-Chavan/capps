...
config.DASHBOARD_HUB_GROUP  = "Cashtrea Dashboard"
...
config.appIcon = "Cashtrea-logo-icon.svg";
...
config.remoteApplicationDetails = {
    remoteApp1: {
        ...
        federatedModules: {
            ...
            HeaderBar: "./CashtreaHeaderComponent",
...
config.appList = [
  ...
  // {
  //     APP_PAGE: "rating_limit_management/dist",
  //     CLS_ICON_TYPE:'bootstrap',
  //     CLS_ICON: "border-style",
  //     APP_NAME: "Rating Limit Management"
  // },
  {
  ...
  {
    APP_PAGE:"capps/dist/index.html#/lcbg/pages/operation-dashboard",
    CLS_ICON:"icon-LCBG",
    APP_NAME:"LCBG"
  },
  {
    APP_PAGE:"capps/dist/index.html#/fxhedging/pages/fx_hedging",
    CLS_ICON:"icon-FX_Hedge",
    APP_NAME:"FX Hedge"
  }
]