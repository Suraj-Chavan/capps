...
export default {
  ...
  methods: {
    ...
    drawChart() {
      ...
      let x =[];
      let y=[];
      if (!this.datasource.filterData) 
      {
        x = pluck(this.datasource.data, this.conf.x);
        y = pluck(this.datasource.data, this.conf.y); 
      }
      else
      {
        x = pluck(this.datasource.filterData, this.conf.x);
        y = pluck(this.datasource.filterData, this.conf.y);
