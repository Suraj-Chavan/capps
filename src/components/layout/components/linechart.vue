...
export default {
  ...
  data() {
    var conf = this.configuration ?  JSON.parse(JSON.stringify(this.configuration)) : {layout:{title : ''}, x : '', y :''};
    conf = Object.assign({layout:{title : ''}, x : '', y :''}, conf);
    var ID = "linechart" + Date.now();
