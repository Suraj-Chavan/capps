	...
	<span class="upload-container">
		...
		>
			<g>
				<g>
					<path
						d="M385.766,352.367l-34.133-34.133c-3.336-3.336-8.73-3.336-12.066,0l-34.133,34.133c-3.337,3.337-3.337,8.73,0,12.066
			s8.73,3.336,12.066,0l19.567-19.567v98.867c0,4.71,3.823,8.533,8.533,8.533c4.71,0,8.533-3.823,8.533-8.533v-98.867l19.567,19.567
			c1.664,1.664,3.849,2.5,6.033,2.5c2.185,0,4.369-0.836,6.033-2.5C389.103,361.097,389.103,355.703,385.766,352.367z"
					/>
				</g>
			</g>
			<g>
...
<script>
export default {
	name: "UploadIcon", // Name your component
};
</script>
